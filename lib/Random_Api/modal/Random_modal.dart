...
RandomUserModel randomPersonFromJson(String str) => RandomUserModel.fromJson(json.decode(str));

String randomPersonToJson(RandomUserModel data) => json.encode(data.toJson());
